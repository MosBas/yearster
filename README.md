...
- **ניקוד** = מרחק (בשנים) בין הניחוש לשנה האמיתית
- **פגיעה מדויקת** = **בונוס -5 נקודות**
- **אותו שיר לא חוזר פעמיים** — השירים מעורבבים ונחתכים מראש
- **מנצח** — השחקן עם הניקוד **הנמוך ביותר**
...
points = distance === 0 ? -5 : distance    // בונוס לפגיעה מדויקת
total = sum of all points (lower is better)
```
